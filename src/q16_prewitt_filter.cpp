...
int main(int argc, char *argv[])
{
    ...
    imwrite("../pictures_results/q16_longitude.jpg", differ_longitude);
    imwrite("../pictures_results/q16_horizon.jpg", differ_horizon);

    imshow("prewitt_filter_longi", differ_longitude);
    waitKey(0);
    imshow("prewitt_filter_horizon", differ_horizon);
    waitKey(0);
    destroyAllWindows();
