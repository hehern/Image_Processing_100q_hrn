...
int main(int argc, char *argv[])
{
    ...
    imwrite("../pictures_results/q15_longitude.jpg", differ_longitude);
    imwrite("../pictures_results/q15_horizon.jpg", differ_horizon);

    imshow("sobel_filter_longi", differ_longitude);
    waitKey(0);
    imshow("sobel_filter_horizon", differ_horizon);
    waitKey(0);
    destroyAllWindows();
